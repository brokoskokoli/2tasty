 ...
 */
final class Version20190404200024 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipe_list_recipe (recipe_list_id INT NOT NULL, recipe_id INT NOT NULL, INDEX IDX_97AA3D7D714A18CB (recipe_list_id), INDEX IDX_97AA3D7D59D8A214 (recipe_id), PRIMARY KEY(recipe_list_id, recipe_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE recipe_list_recipe ADD CONSTRAINT FK_97AA3D7D59D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recipe_list_recipe ADD CONSTRAINT FK_97AA3D7D714A18CB FOREIGN KEY (recipe_list_id) REFERENCES recipe_list (id) ON DELETE CASCADE');
