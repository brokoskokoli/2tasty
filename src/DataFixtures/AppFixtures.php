...
class AppFixtures extends Fixture
{
    ...
    {
        foreach ($this->getRecipeData() as [$title, $slug, $summary, $content, $publishedAt, $author, $recipeTags]) {
            $recipe = new Recipe();
    ...
    private function getRecipeData()
    {
        ...
        foreach ($this->getPhrases() as $i => $title) {
            // $recipeData = [$title, $slug, $summary, $content, $publishedAt, $author, $recipeTags, $comments];
            $recipes[] = [
                $title,
                ...
                // Ensure that the first recipe is written by Jane Doe to simplify tests
    ...
    private function getRecipeContent(): string
    {
        return <<<'MARKDOWN'
